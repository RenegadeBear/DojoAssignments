...
<body>
    <div class="container">
        ...
        <div class="columns">
            <div class="column">
                <h2 class="title is-h2">Edit ${tvshow.name}</h2>
            
                <form:form method="POST" action="/updateshow/${tvshow.id}" modelAttribute="tvshow">
                    <div class="field">
                    ...
                    <input type="hidden" path="avg_rating" name="avg_rating" value="${tvshow.avg_rating}"/>
                ...
                <div>
                    <a href="delete/${tvshow.id}"><button class="button is-danger" style="float:right;">Delete</button></a>
                </div>
